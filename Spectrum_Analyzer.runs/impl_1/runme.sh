...
HD_PWD='C:/Xilinx/Vivado/Spectrum_Analyzer/Spectrum_Analyzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Spectrum_Analyzer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Spectrum_Analyzer_top.tcl -notrace
