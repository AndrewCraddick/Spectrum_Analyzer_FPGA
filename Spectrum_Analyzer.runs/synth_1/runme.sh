...
HD_PWD='C:/Xilinx/Vivado/Spectrum_Analyzer/Spectrum_Analyzer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Spectrum_Analyzer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Spectrum_Analyzer_top.tcl
